...
@classes.ability.passive_ability(
        ...
        description="You have access to Mafia night meeting. If there is no living <:maficon:891739940055052328>**Mafioso**, you have the __fourth__ priority to become the <:maficon:891739940055052328> **Mafioso**",
)
...
@classes.ability.ability(
    utils.notMafiaAndNotDead,
    -1,
    "Stakeout",
    "__Stake out__ target player. You will learn who your target visits, and who visits your target.",
    "🔭",
    "watch over"
)
