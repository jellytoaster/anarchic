...
async def kill(targetPlayers:list, originPlayer:classes.player.Player, game):
    ...
    await targetPlayer.kill(classes.enums.DeathReason.Enforcer, game)
...
class Vigilante(role.Role):
    def __init__(self, name: str, faction: classes.enums.Faction):
        ...
        self.abilities = [classes.ability.Ability(kill, utils.notMeAndNotDead, 3, "Shoot", "__Attack__ target player. If you kill a **Town <:town:1007768656341651547>**, lose all charges of __Eliminate__ <:vgicon:890339050865696798>. Cannot be used **Night 1 <:moon:934556372421451776>**.", "<:vgicon:890339050865696798>", "shoot", isUsable)]
