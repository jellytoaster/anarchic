...
class Doctor(role.Role):
    def __init__(self, name: str, faction: classes.enums.Faction):
        ...
        self.abilities = [classes.ability.Ability(protect, -1, "Heal", "__Heal__ target player. You will grant your target a __Powerful Resistance__ for the night. Both you and your target will be notified if your target is __attacked__.", "💖", "heal")]
