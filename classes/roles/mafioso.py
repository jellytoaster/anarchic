...
class Mafioso(role.Role):
    def __init__(self, name: str, faction: classes.enums.Faction):
        ...
        self.color = 0xd0021b
        self.order = 8
        self.targetingOptions = utils.notMafiaAndNotDead
        ...
        self.abilities = [classes.ability.Ability(kill, -1, "Assassinate", "Attack target player. They'll probably die.", "<:maficon:891739940055052328>", "kill")]
