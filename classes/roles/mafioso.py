...
class Mafioso(role.Role):
    def __init__(self, name: str, faction: classes.enums.Faction):
        ...
        self.abilities = [classes.ability.Ability(kill, utils.notMafiaAndNotDead, -1, "Assassinate", "Attack target player. They'll probably die.", "<:maficon:891739940055052328>", "kill")]
