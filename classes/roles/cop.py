...
class Cop(role.Role):
    def __init__(self, name: str, faction: classes.enums.Faction):
        ...
        self.abilities = [classes.ability.Ability(interrogate, -1, "Interrogate", " __Investigate__ target player. You will learn if they are __Innocent__ <:inno:873636640227205160>, __sided__ with the **Mafia <:mafia:1007768566789050378>**, or __Psychotic__ <:psycho:877584821180825691>.", "📝", "interrogate")]
