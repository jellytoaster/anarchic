...
class Jester(role.Role):
    def __init__(self, name: str, faction: classes.enums.Faction):
        ...
        self.abilities = [classes.ability.Ability(kill, utils.playersWhoVotedGuilty, 1, "Haunt", "Haunt a player so they die.", "<:jesticon2:889968373612560394>", "haunt", utils.jesterDeathCheck),classes.ability.Ability()]
