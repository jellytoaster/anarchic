...
class Jester(role.Role):
    def __init__(self, name: str, faction: classes.enums.Faction):
        ...
        self.color = 0xf1cbe2
        self.order = 1
        self.targetingOptions = utils.playersWhoVotedGuilty
        ...
        self.abilities = [classes.ability.Ability(kill, 1, "Haunt", "Haunt a player so they die.", "<:jesticon2:889968373612560394>", "haunt", utils.jesterDeathCheck)]
