...
deathEmbeds = {classes.enums.DeathReason.Mafia : disnake.Embed(title="**You were attacked by a member of the Mafia**", colour=disnake.Colour(0xd0021b), description="**You have died <:rip:878415658885480468>**").set_thumbnail(url="https://cdn.discordapp.com/emojis/890328238029697044.png?size=80"),
               classes.enums.DeathReason.Mafia : disnake.Embed(title="**You could not get over your guilt of lynching the Jester <:jesticon2:889968373612560394>**", colour=disnake.Colour(0xf1cbe2), description="**You have died <:rip:878415658885480468>**").set_thumbnail(url="https://cdn.discordapp.com/emojis/872187561597075476.webp?size=80&quality=lossless"),
